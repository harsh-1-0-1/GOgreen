...
import { FolderTree, Image, LayoutDashboard, MoreHorizontal, Package, ShoppingCart, Users, X, FileText, Briefcase, Tag, Settings, PlaySquare, ShieldAlert, AlertCircle } from 'lucide-react';
