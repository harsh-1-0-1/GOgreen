...
class BannerBase(BaseModel):
    ...
    placement: str = Field(
        default="hero",
        pattern=r"^(hero|announcement|page|themed|strip|highlight|mobile_promo|corporate_gifting|happy_planters|trending|product_detail|product_spec|product_strip)$",
    )
